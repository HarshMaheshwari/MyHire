...
public partial class Dashboard : System.Web.UI.Page
{
    ...
    ClientBAL clientbal;
    int UserId, Role, count, CountRq, CountRRNumber, Request_Id, CRole, Usr_Id, UserRole;
    static string[,] QueryArray = new string[3, 2], Candidatename;
    Search srch;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Session["UserName"] = Session["Candidate_Name"];
        //Session["UserName"] = Session["CEmail"];
        //Session["UserName"] = Session["Candidate_Name"];
        //Session["CRole"] = Session["UserRole"];

        CRole = Convert.ToInt32(Session["CRole"]);
        Usr_Id = Convert.ToInt32(Session["Candidate_Id"]);
    ...
    protected void BindGrid1()
    {
        try
        {
            ...
            gdvVideoQue.DataSource = recruitbal.GetVideoQuestion();
            gdvVideoQue.DataBind();
        }
        catch (Exception ex)
        {
        }
    ...
    protected void BindGrid()
    {
        ...
        try
        {
            ...
            if (txtDesigntn.Text != "")
            {
                QueryArray[count, 0] = "Rr.Job_Profile";
                QueryArray[count, 1] = txtDesigntn.Text;
                count = count + 1;
            }
            if (txtRRNo.Text != "")
            {
                QueryArray[count, 0] = "Rr.RRNumber";
                QueryArray[count, 1] = txtRRNo.Text;
                count = count + 1;
            }
    ...
    {
        Response.Redirect("NewPosition.aspx");
    }
    protected void btnEditProfile_Click(object sender, EventArgs e)
    {
        Response.Redirect("CandidtateProfile.aspx");
    }
    ...
    protected void gdvRequest_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "edit")
        {
            ...
            string url = "NewPosition.aspx?Id=" + Id;
            Response.Redirect(url);
        }
        else if (e.CommandName == "Candidates")
        {
            GridViewRow gvr = (GridViewRow)((Control)e.CommandSource).NamingContainer;
            int Id = Convert.ToInt32(((Label)gvr.FindControl("lblId")).Text);
            string url = "VintroVideo.aspx?Id=" + Id;
            Response.Redirect(url);
        ...
        else if (e.CommandName == "Candidate")
        {
            ...
            Session["Rid"] = Id;
            Session["BackF"] = "1";
            Response.Redirect("CandidateListForHR.aspx");
        }
        else if (e.CommandName == "Video")
        {
            ...
            Session["Rid"] = Id;
            Session["BackF"] = "2";
            Response.Redirect("CanditateListForhrAdmin.aspx");
        }
        else if (e.CommandName == "Upload")
        {
            GridViewRow gvr = (GridViewRow)((Control)e.CommandSource).NamingContainer;
            int Id = Convert.ToInt32(((Label)gvr.FindControl("lblId")).Text);
            Session["Flag"] = "1";
            string url = "CandidateList.aspx?Id=" + Id;
            Response.Redirect(url);
        }
        //else if (e.CommandName == "excelupload")
        //{
        //    GridViewRow gvr = (GridViewRow)((Control)e.CommandSource).NamingContainer;
        //    string Id = ((Label)gvr.FindControl("lblId")).Text;
        //    Session["Rid"] = Id;
        //    Session["BackF"] = "1";
        //    Response.Redirect("UploadRRCandidate.aspx");
        //}
        else
        {
    ...
    public DataTable SearchRequset()
    {
        ...
        sb.Append(" Rr.JobFile_Path, Rr.Status,  Rr.Request_By, Ccp.Person_Name, cy.City_Name");
