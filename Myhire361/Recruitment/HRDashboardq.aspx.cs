...
public partial class Recruitment_HRDashboard : BaseClass
{
    ...
    ClientBAL clientbal;
    int UserId, Role, count, CountRq, CountRRNumber;
   ...
   protected void gdvRequest_RowCommand(object sender, GridViewCommandEventArgs e)
   {
    ...
    public DataTable SearchRequset()
    {
        ...
        sb.Append(" Select Rr.Request_Id,Rr.RRNumber,Rr.Client_Id,Cd.Client_Name,Request_By,");
        sb.Append(" Rr.Designation,Rr.Min_Salary, Rr.Max_Salary, Rr.Min_Experience,Rr.Max_Experience, Rr.Request_Status,");
        sb.Append("  Rr.Status");
        sb.Append(" From RecruitmentRequest AS Rr INNER JOIN ClientDetail AS Cd ON Rr.Client_Id = Cd.Client_Id INNER JOIN");
        sb.Append(" ClientContactPerson AS Ccp ON Rr.Request_By = Ccp.Contact_PersonId");
