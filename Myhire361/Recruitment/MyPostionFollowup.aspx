<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="MyPostionFollowup.aspx.cs" Inherits="Recruitment_MyPostionFollowup" %>
                    ...
                    <fieldset>
                        ...
                        <table width="100%">
                            <tr>
                             ...
                             <tr>
                            <td class="style4">Resume Title </td>
                            <td colspan="3"> :
                                    <asp:Label ID="lblResumeTittle" runat="server"></asp:Label></td>
                            </tr>
                             <tr>
                                <td class="style4">
                                    Company
                             ...
                             <tr>
                            <td class="style4">Qualification </td>
                            <td colspan="3"> :
                            ...
                            <td colspan="3">
                             ...
                             <tr >
                                ...
                                <td colspan="2">
                                :
                                <asp:Label ID="lblLastActiveDate" runat="server" Visible="false"></asp:Label></td>
                                <td>
                            ...
                            <fieldset>
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td style="width: 30%">
                                            <asp:Label ID="lblRecStatus" runat="server" Style="font-weight: 700"></asp:Label>
                                        </td>
                                        <td style="width: 15%">
                                            Next FollowUp Type
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <asp:Label ID="lblCanStatus" runat="server" Style="font-weight: 700"></asp:Label>
                                        </td>
                                        <td>
                                            Next FollowUp Time
                                        </td>
