...
public partial class Recruitment_MyPosition : BaseClass
{
    DataTable dt;
    ...
    protected void BindGrid()
    {
        ...
        try
        {
            ...
            recruitbal.ConsultantId = UserId;
           
            dv.Table  = recruitbal.GetRequestByConsultant();
    ...
    public DataTable SearchMyPosition()
    {
        srch = new Search();
        ...
        sb.Append("  LEFT OUTER JOIN UserClientRelation AS Cr ON Rr.Request_Id = Cr.Request_Id   ");
        sb.Append(" left outer join CandidateDetail as cnd on Ccp.Contact_PersonId=cnd.CreatedBy   ");
        
        sb.Append(" WHERE (Cr.Consultant_Id = " + UserId + ") AND (Cr.Status = 1) AND (Rr.Status=1)   ");
        sb.Append(" AND (Rr.Request_Status='Open' OR Rr.Request_Status='Partialy Closed' OR Rr.Request_Status='Submitted' ) ");
