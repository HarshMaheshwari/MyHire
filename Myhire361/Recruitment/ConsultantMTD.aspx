<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ConsultantMTD.aspx.cs" Inherits="Recruitment_ConsultantMTD" %>
                            ...
                            <td align="center" width="20%">
                                 ...
                                 <asp:DropDownList CssClass="DropDown" ID="ddlCandStatus" runat="server">
                                        ...
                                        <asp:ListItem Text="Offer Accepted" Value="Offer Accepted"></asp:ListItem>
                                         <asp:ListItem Text="Interview Done" Value="Interview Done"></asp:ListItem>
                                        ...
                                        <asp:ListItem Text="CV Shared With Client" Value="CV Shared With Client"></asp:ListItem>
                                   
                                        <asp:ListItem Text="Share CV with Client" Value="Share CV with Client"></asp:ListItem>
                                        <asp:ListItem Text="Selected not Joined" Value="Selected not Joined"></asp:ListItem>
                           
                             </asp:DropDownList>
                            </td>
                              <td align="center">
                                <asp:TextBox ID="txtfromDate" runat="server" CssClass="TxtBox"  Width="90px"></asp:TextBox>
                                 <asp:CalendarExtender ID="CEtxtfromDate" runat="server" Format="dd-MMM-yyyy"
                                                PopupButtonID="txtfromDate" TargetControlID="txtfromDate">
                                  </asp:CalendarExtender>
                            </td>
                             <td align="center">
                                <asp:TextBox ID="txtToDate" runat="server" CssClass="TxtBox"  Width="90px"></asp:TextBox>
                                 <asp:CalendarExtender ID="CEToDate" runat="server" Format="dd-MMM-yyyy"
