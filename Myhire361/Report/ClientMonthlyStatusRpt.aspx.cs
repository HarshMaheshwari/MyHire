...
using System.IO;
public partial class Report_ClientMonthlyStatusRpt : BaseClass
{
    ...
    public DataTable SearchOverallMonthlyWS()
    {
        ...
        dt = dws.GetOverallStatusforCMWS();
        string a = "";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                a = a + (dt.Rows[i]["OverallStatus"].ToString() + "],[");
            ...
            sb.Append("select * from ( select u.USR_Name as Consultant ,r.RRNumber,cd.Client_Name, r.Job_Profile as Role_JobProfile,OverallStatus as OverallStatus,CandidateNo ,ccd.Person_Name as HR_Contact  ");
            sb.Append(" from ClientMonthlyWorkSummary as dl ");
            ...
            sb.Append(" (sum(CandidateNo) FOR OverallStatus IN ([" + a + ")) as pvt");
    ...
    protected void lbtnDownload_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filename = "ClientMonthlyStatus(" + DateTime.Now.AddMinutes(MyTimeSpan).ToString("dd-MMM-yyyy") + ").xls";
