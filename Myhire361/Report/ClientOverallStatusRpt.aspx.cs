...
public partial class Report_ClientOverallStatusRpt : BaseClass
{
    ...
    public DataTable SearchOverallMonthlyWS()
    {
       ...
       dt = dws.GetOverallStatusforCOWS();
        string a = "";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            sb.Append(" from ClientOverallWorkSummary as dl ");
    ...
    protected void lbtnDownload_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filename = "ClientOverallStatus(" + DateTime.Now.AddMinutes(MyTimeSpan).ToString("dd-MMM-yyyy") + ").xls";
