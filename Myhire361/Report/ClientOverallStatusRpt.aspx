<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ClientOverallStatusRpt.aspx.cs" Inherits="Report_ClientOverallStatusRpt" %>
                   ...
                   <asp:Panel ID="pnlUpload" runat="server" Width="1194px" ScrollBars="Auto" Height="800px">
                          <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                     ...
                                     <div style="height: 800px; overflow: auto" align="center">
                 <asp:GridView ID="gdvDWS" runat="server" CssClass="mRprtGrid" AutoGenerateColumns="true"
