<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PositionstoBeBilled.aspx.cs" Inherits="Report_PositionstoBeBilled" %>
                                     ...
                                     <asp:TemplateField HeaderText="Role" SortExpression="Job_Profile">
                                         ...
                                         <asp:TemplateField HeaderText="Candidate" SortExpression="Candidate_Name">
                                           ...
                                           <asp:TemplateField HeaderText="Candidate Status" SortExpression="Overall_Status">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <EditItemTemplate>
                                           <asp:TextBox ID="txtEBillingDate" runat="server" CssClass="TxtBox" Text='<%#Eval("BillingDate")%>'  Width="80px"></asp:TextBox>
                                      ...
                                      <asp:TemplateField HeaderText="Billed Amount" SortExpression="BillingAmount">
                                            <ItemTemplate>
                                               ...
                                               <EditItemTemplate>
                                           <asp:TextBox ID="txtEBillingAmount" runat="server" CssClass="TxtBox" Text='<%#Eval("BillingAmount")%>' Width="80px"></asp:TextBox>
                                          ...
                                          <asp:TemplateField HeaderText="S Tax" SortExpression="ServiceTax">
                                            <ItemTemplate>
                                               ...
                                               <EditItemTemplate>
                                           <asp:TextBox ID="txtEServiceTax" runat="server" CssClass="TxtBox" Text='<%#Eval("ServiceTax")%>' Width="40px"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Billing Status" SortExpression="BillStatus">
                                            <ItemTemplate>
                                               ...
                                               <asp:Label ID="lblEBillStatusId" runat="server" Text='<%#Eval("BillStatusId") %>' Visible="false"></asp:Label>
                                                    <asp:DropDownList ID="ddlEBillStatus" runat="server" AppendDataBoundItems="True" CssClass="DropDown" Width="100px" > 
                                                    </asp:DropDownList>
                                                     </EditItemTemplate>
                                        ...
                                        <%--  <asp:TemplateField HeaderText="Payment Status" SortExpression="PaymentStatus">
                                            <ItemTemplate>
                                               ...
                                               <asp:Label ID="lblEPaymentStatusId" runat="server" Text='<%#Eval("PaymentStatusId") %>' Visible="false"></asp:Label>
                                                    <asp:DropDownList ID="ddlEPaymentStatus" runat="server" AppendDataBoundItems="True" CssClass="DropDown" Width="120px" > 
                                                    </asp:DropDownList>
                                                     </EditItemTemplate>
                                              <HeaderStyle HorizontalAlign="Center" Width="120px" />
                                            <ItemStyle HorizontalAlign="Center" Width="120px" />
