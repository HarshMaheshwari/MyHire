<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ConsultantPerformanceDaily.aspx.cs" Inherits="Report_ConsultantPerformanceDaily" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <center>
        <div id="page">
            <h2>
                Consultant Daily Performance</h2>
                  ...
                  <tr>
                   <td>
                    ...
                    <tr align="center">
                            ...
                            <td align="center">
                                  <asp:TextBox ID="txtMonth" runat="server" CssClass="TxtBox"></asp:TextBox>
                            <asp:CalendarExtender ID="CltxtDDate" runat="server" Format="dd-MMM-yyyy"
                                PopupButtonID="txtMonth" TargetControlID="txtMonth">
