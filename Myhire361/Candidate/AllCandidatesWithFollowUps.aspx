<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="AllCandidatesWithFollowUps.aspx.cs" Inherits="Recruitment_AllCandidatesWithFollowUps" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <center>
        <div id="page" style="min-height: 450px">
            <h2>
                Search Candidates-By Remarks</h2>
            <table width="100%" align="center">
                ...
                <tr>
                    ...
                    <td width="20%">
                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="TxtBox" Width="140px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td width="20%" align="center">
                                ...
                                <asp:GridView ID="gdvCandidate" runat="server" AutoGenerateColumns="False" DataKeyNames="Candidate_Id"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Experience" SortExpression="WorkExp">
                                            <ItemTemplate>
                                                <asp:Label ID="lblExp" runat="server" Text='<%#Eval("WorkExp")%>' Width="60px" CssClass="clsWrap"  ></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
