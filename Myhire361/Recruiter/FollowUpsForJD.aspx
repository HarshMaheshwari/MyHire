<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="FollowUpsForJD.aspx.cs" Inherits="FollowUpsForJD" %>
            ...
            <table width="100%" >
              ...
              <asp:Panel ID="PnlCandidate" runat="server" Width="100%">
                    ...
                    <table style="width:100%">
                        ...
                        <tr>
                            <td>
                                  <asp:GridView ID="gdvfollowupjd" runat="server" AutoGenerateColumns="False" DataKeyNames="Candidate_Id"
                                    ...
                                    <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Current Employer" SortExpression="Designation">
                                            <ItemTemplate>
