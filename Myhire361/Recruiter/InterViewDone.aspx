<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="InterViewDone.aspx.cs" Inherits="InterViewDone" %>
        ...
        <table width="100%" align="center">
             <tr>
                    <td align="left" valign="top" colspan="3">
                        ...
                        <asp:Button runat="server" ID="btnintervdone" Text="Interview" CssClass="btnCancel" Width="100px" OnClick="btnintervdone_Click"  />
                        <asp:Button runat="server" ID="Button5" Text="Selected" CssClass="btnCancel" Width="100px"  OnClick="Button5_Click"/>
