<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true"
    CodeFile="TodayStatus.aspx.cs" Inherits="TodayStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="page" style="height:600px;margin-top: 26px;">
        <center>
                       ...
                       <asp:Panel ID="Admin" runat="server" CssClass="pnltop" ScrollBars="Auto">
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                <ContentTemplate>
                                 <h2>
                            &nbsp;Today's Status</h2>
                                    <asp:GridView ID="gdvToday" runat="server" AutoGenerateColumns="true" 
                         onrowcreated="gdvToday_RowCreated"  
                                            EmptyDataText="No Today Status" 
                            onrowdatabound="gdvToday_RowDataBound"  CssClass="mGridDash" >
                            <%--  OnPreRender="gdv_PreRender"--%>
                        </asp:GridView>
                     
                                </ContentTemplate>
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="gdvToday" EventName="RowCommand" />
                                </Triggers>
                            </asp:UpdatePanel>
                        </asp:Panel>
            ...
            <tr>
                <td colspan="2" align="left" style="font-weight: 700">&nbsp;</td>
                </tr>
            </table>
        </center>
    </div>
