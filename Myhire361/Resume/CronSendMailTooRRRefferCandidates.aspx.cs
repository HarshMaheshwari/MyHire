      ...
      //  userbal = new LoginBAL();
        try
        {
           ...
           for (int i = 0; i < dt.Rows.Count; i++)
            ...
            string Email = dt.Rows[i]["Email"].ToString();//"ishan3333@gmail.com";//
        ...
        //    dts = followup.GetOldFollowupByIdForMail();
            ...
            MsgBody = MsgBody + " <h2> 210 Jobs worth Referral Value of <br>";
            MsgBody = MsgBody + "  Rs.15 Lacs on India Hiring! Refer Now! </h2><br>";
