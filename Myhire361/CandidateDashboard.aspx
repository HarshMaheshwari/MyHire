<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CandidateDashboard.aspx.cs" Inherits="Candidate_CandidateDashboard" %>
                    ...
                    <asp:GridView runat="server" AutoGenerateColumns="False" CssClass="mGrid" DataKeyNames="Request_Id"
                        ...
                        Height="20px" Width="20px" ToolTip="Excel upload" />
                                    ...
                                    &nbsp;
                                     ...
                                     <asp:ImageButton ID="ImageButton1" runat="server"  ImageUrl="~/Image/Video.png"
